...
namespace Obscura
{
    public class FourWaySpeedupPushZoneCameraController : AbstractCameraController
    {
        ...
        [SerializeField] public float pushRatio;
        ...
        void LateUpdate()
        {
            ...
            var playerDirection = Target.GetComponent<PlayerController>().GetMovementDirection();
            var playerSpeed = Target.GetComponent<PlayerController>().GetCurrentSpeed();
